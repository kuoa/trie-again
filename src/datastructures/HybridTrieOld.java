...
public class HybridTrieOld implements ITrie {
	
	public HybridTrieOld left, right, middle;
	public char letter;
	...
	public HybridTrieOld() {
		isNull = true;
		isEnd = false;
		height = 0;
	}
	
	public static HybridTrieOld nullHT() {
		return new HybridTrieOld();
	}
	...
	private static HybridTrieOld balance(HybridTrieOld A) {
	...
	private static HybridTrieOld rotateLeft(HybridTrieOld a) {
		HybridTrieOld nv = a.right;
		a.right = nv.left;
		nv.left = a;
	...
	private static HybridTrieOld rotateRight(HybridTrieOld a) {
		HybridTrieOld nv = a.left;
		a.left = nv.right;
		nv.right = a;
...
//	return false;
	...
	@Override
	public HybridTrieOld clone() {
		if(isNull) return nullHT();

		HybridTrieOld nt = new HybridTrieOld();
		nt.isEnd = isEnd;
		nt.isNull = isNull;
		nt.letter = letter;
